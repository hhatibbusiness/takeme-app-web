                                ...
                                <div className={'Items__container'} style={itemsContainerStyles}>
                                    {
                                        fetchingItems ? (
                                            ...
                                            <Items value={value} setCurrentProduct={setCurrentProduct} curItemTypeId={curItemTypeId} fetchProductsMarket={fetchProductsMarket} items={items} itemsPage={itemsPage} moreItems={moreItems} />
                                            // <ProductList currentProduct={currentProduct} setCurrentProduct={setCurrentProduct}/>
                                        )
                                    }
                                </div>
