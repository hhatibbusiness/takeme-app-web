...
const CoverImg = ({ image, loaded, setLoaded }) => {
    ...
    return (
        <div ref={imgContainerRef} className={`CoverImg ${imgLoaded ? 'Cover__visible' : 'Cover__hidden'}`}>
            ...
            {/*{(true) && <LoadingProduct priceStartFrom={false} priceTitle={false} imgLoaded={false} details={false} btn={false} />}*/}
