...
export default function WarningAlarm({ CloseFun, SaveFun , typeSrc, message }) {
        ...
        <div className="PopUp-Warning-container">
                <div className="PopUp-Warning">
                    ...
                    <div dir="rtl" className="warning-save-cancel-button-container">
                        <div className="warning-save-cancel-button warning__save-button"   onClick={SaveFun}>موافق</div>
