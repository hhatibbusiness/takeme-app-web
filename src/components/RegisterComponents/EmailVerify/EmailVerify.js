...
const PhoneVerify = ({setStep, forget, registerError, buttonText, buttonLink, form, sendCodeFun, sendingCode, lan, sendCodeToServerFun, sendingCodeToServer}) => {
    ...
    useEffect(() => {
        if(!conRef.current) return;const inputs = conRef.current.querySelectorAll('.PhoneVerify__input');
